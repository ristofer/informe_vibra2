...
\begin{images}[\label{fig:1}]{Análisis en frecuencia de respuesta del sistema.}
	\addimage{frecuencias3.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 3 Hz}
	\addimage{frecuencias3-5.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 3,5 Hz}
	\addimage{frecuencias4.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 4 Hz}
	\addimage{frecuencias4-5.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 4,5 Hz}
	\addimage{frecuencias5.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 5 Hz}
	\addimage{frecuencias5-5.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 5,5 Hz}
\end{images}

\newpage
\begin{images}[\label{fig:2}]{Análisis en frecuencia de respuesta del sistema.}
\addimage{frecuencias6.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 6 Hz}
\addimage{frecuencias6-5.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 6,5 Hz}
\addimage{frecuencias7.png}{width=7cm}{Transformada de Fourier para experimento con velocidad de motor 7 Hz}
\end{images}
