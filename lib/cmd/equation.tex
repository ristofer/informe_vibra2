	...
	\else
		\ifthenelse{\equal{\numberedequation}{true}}{
			...
			\begin{gather}
				\ensuremath{#1}
			\end{gather}
			\vspace{\margingathercaptiontop cm}
			\begin{changemargin}{\captionlrmargin cm}{\captionlrmargin cm}
				\centering \textcolor{\captiontextcolor}{#2}
				\vspace{\margingathercaptionbottom cm}
			\end{changemargin}
			\vspace{\margingathercaptionbottom cm}
		}{
	...
	\else
		\ifthenelse{\equal{\numberedequation}{true}}{
			...
			\begin{align}
				\ensuremath{#1}
			\end{align}
			\vspace{\marginaligncaptiontop cm}
			\begin{changemargin}{\captionlrmargin cm}{\captionlrmargin cm}
				\centering \textcolor{\captiontextcolor}{#2}
				\vspace{\marginaligncaptionbottom cm}
			\end{changemargin}
			\vspace{\marginaligncaptionbottom cm}
		}{
